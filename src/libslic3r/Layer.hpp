...
public:
    ...
    // Set while generating fills when this layer contains a one-sided arc overhang.
    // G-code uses it to slow only the follow-up stabilization layers, not arc bridges.
    mutable bool                has_one_sided_arc_overhang = false;
...
public:
    ...
    // True when this layer contains the roof/contact interface directly below the object.
    bool                        has_top_interface_contact = false;
