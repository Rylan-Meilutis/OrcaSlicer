...
std::map<std::string, std::vector<SimpleSettingData>> SettingsFactory::PART_CATEGORY_SETTINGS =
    {{L("Quality"),
      {{"ironing_type", "", 8},
       ...
       {"top_surface_z_mode", "", 1},
       {"zaa_minimize_perimeter_height", "", 2},
       {"zaa_dont_alternate_fill_direction", "", 3},
       {"zaa_min_z", "", 4},
       {"perimeter_layering", "", 5},
       {"nonplanar_top_surface_max_angle", "", 6},
       {"nonplanar_top_surface_layers", "", 7},
       {"nonplanar_top_surface_resolution", "", 8},
       {"nonplanar_top_surface_min_height", "", 9}}},
     {L("Strength"),
      {{"wall_loops", "", 1},
